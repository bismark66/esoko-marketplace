...
export default function Checkout() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (paymentMethod === 'mobileMoney') {
      if (!paymentDetails.mobileMoney.network || !paymentDetails.mobileMoney.phoneNumber) {
        setError('Please fill in all mobile money details');
        return;
      }
    } else {
      if (!paymentDetails.creditCard.cardNumber || !paymentDetails.creditCard.cardName || 
